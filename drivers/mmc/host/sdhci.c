...
{
	local_irq_save(*flags);
	return kmap_atomic(sg_page(sg), KM_USER0) + sg->offset;		// 4_2_4
}

static void sdhci_kunmap_atomic(void *buffer, unsigned long *flags)
{
	kunmap_atomic(buffer, KM_USER0);	// 4_2_4
	local_irq_restore(*flags);
}
 ...
 * simultaneously, hardware generates CRC error. This is a software
 * work-around to avoid the CRC error.
 */
